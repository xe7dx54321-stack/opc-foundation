...
> **版本**：1.0
> **生成时间**：2026-06-26T02:39:13Z
> **Trial 说明**：本报告为 M3C-2D trial-only 试运行结果，**不代表最终 production TRAE 接管**。

## 1. 执行摘要

- **执行时间**：2026-06-26T02:38:43Z ~ 2026-06-26T02:39:13Z
- **Trial Source 总数**：16
- **Dry-run**：否
- **Proxy 启用**：否
- **Proxy 模式**：none
...
| microsoft_ir | Microsoft Investor Relations | 0  |
...
| source_id | source_name | candidates |
|---|---|---|
| goldman_sachs_research | Goldman Sachs Research | 0 （error: HTTP 404: HTTP Error 404: Not Found...） |
...
- **Allowlist**：configs/foundation_trial_source_allowlist.example.yaml
- **Trial Config**：configs/trae_foundation_trial_sources.example.yaml
